...
This sample contains two screens: a list of products and a detail view, that shows location reviews.
...
* A fragment to display a location review.
...
To access the data and execute queries, you use a [Data Access Object](https://developer.android.com/topic/libraries/architecture/room.html#daos) (DAO). For example, a location is loaded with the following query:
